...
import { AdoptionScreen } from "./src/screens/Adoption";
...
export default function App() {
  const { pet, currentUser, loading, login, logout, adoptPet, drawPet } =
    usePet();
  ...
  // 2. 已登录但无宠物状态：显示领养页面
  if (!pet) {
    return <AdoptionScreen onAdopt={adoptPet} onDraw={drawPet} />;
  }
